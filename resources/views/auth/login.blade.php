...
<head>
    ...
    <title>Login Pages | WA Blast</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('templateAdmin') }}/assets/img/sa.png" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('templateAdmin') }}/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                    <!-- <img src="{{ asset('templateAdmin') }}/assets/img/sa.png" alt="WA Blast" width="25"> -->
                                </span>
                                <span class="app-brand-text demo text-body fw-bolder" style="text-transform: capitalize">Abitour Travel</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Selamat Datang Kembali! 👋</h4>
                        <p class="mb-4">Silahkan login untuk masuk ke Abitour Travel</p>
